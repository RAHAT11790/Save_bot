#!/usr/bin/env python3
"""
Telegram Media Bridge - No Hardcoded Tokens
...
if not all([API_ID, API_HASH, BOT_TOKEN, OWNER_ID]):
    raise ValueError("❌ Missing required environment variables: API_ID, API_HASH, BOT_TOKEN, OWNER_ID")
...
class TeleHelper:
    ...
    def upload_to_telegram_bot(self, file_path, caption, media_type, file_name):
        """Upload to bot using Telegram Bot API"""
        try:
            import requests
...
def text_message_handler(update: Update, context: CallbackContext):
    ...
    update.message.reply_text("🔍 **লিংক ডিটেক্টেড!**\n\n📥 ডাউনলোড শুরু হচ্ছে...")
